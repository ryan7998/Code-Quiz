...
/**
 * Create quizQuestions array with objects values of question, answer and correct answers
 */
var quizQuestions = [
	{
...
// Create Start Button for Home Page:
...
// Set High Score link: On Click initiate getHighScore function
...
btnGoback.setAttribute('style', 'background: #171f4f;color: #fff;border-radius: 5px;padding: 1em;font-size: 1em');

// button clear high score:
var btnClearScore = document.createElement('button');
btnClearScore.innerText="Clear Score";
btnClearScore.setAttribute('style', 'background: #171f4f;color: #fff;border-radius: 5px;padding: 1em;font-size: 1em');
...
function getHighScore(){
    ...
    headerDiv.setAttribute('style', 'display: flex;justify-content: center;margin:20px;');

    if(highScorearr != null){
        highScoreDiv = document.createElement('div');
        highScoreDiv.setAttribute('style', 'display: flex; align-items: center; justify-content: space-around; background: #faebd7; padding: .5em; margin:1px;');
    ...
    btnDiv.setAttribute('style', 'display:flex; justify-content:space-around; margin: 2em;');
